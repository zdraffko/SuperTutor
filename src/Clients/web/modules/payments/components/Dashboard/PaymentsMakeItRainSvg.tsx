const PaymentsMakeItRainSvg: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" data-name="Layer 1" width="974" height="714.52" viewBox="0 0 974 714.52">
        <defs>
            <linearGradient id="0716a939-3e70-42e2-b2a4-62d4623bb7b7-332" x1="574.72" y1="713.31" x2="574.72" y2="358.2" gradientUnits="userSpaceOnUse">
                <stop offset="0" stopColor="gray" stopOpacity="0.25" />
                <stop offset="0.54" stopColor="gray" stopOpacity="0.12" />
                <stop offset="1" stopColor="gray" stopOpacity="0.1" />
            </linearGradient>
            <linearGradient
                id="246fdb29-47ea-4475-84d7-0cdffd1436cc-333"
                x1="2975.38"
                y1="757.78"
                x2="2975.38"
                y2="205.6"
                gradientTransform="matrix(-1, 0, 0, 1, 3906, 0)"
                xlinkHref="#0716a939-3e70-42e2-b2a4-62d4623bb7b7-332"
            />
        </defs>
        ...
        <path
            ...
            opacity="0.2"
        />
        <path d="M424.88,138.88s-38.65,51.33-11,111.16S365.69,406,365.69,406" transform="translate(-113 -92.74)" fill="none" stroke="#535461" strokeMiterlimit="10" strokeWidth="2" />
        ...
        <path
            ...
            transform="translate(-113 -92.74)"
            fill="url(#0716a939-3e70-42e2-b2a4-62d4623bb7b7-332)"
        />
        <rect x="182.39" y="269.64" width="558.65" height="346.75" rx="24.81" ry="24.81" fill="#15aabf" />
        <rect x="182.39" y="330.32" width="558.65" height="63.57" fill="#15aabf" />
        <rect x="182.39" y="330.32" width="558.65" height="63.57" opacity="0.3" />
        <rect x="235.37" y="441.09" width="452.7" height="30.82" fill="#d6d6e3" />
        <circle cx="272.93" cy="548.97" r="44.31" fill="#15aabf" />
        ...
        <path
            ...
            transform="translate(-113 -92.74)"
            fill="url(#246fdb29-47ea-4475-84d7-0cdffd1436cc-333)"
        />
...
export default PaymentsMakeItRainSvg;
