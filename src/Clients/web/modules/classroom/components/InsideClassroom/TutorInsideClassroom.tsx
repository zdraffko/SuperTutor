...
export const TutorInsideClassroom: React.FC<TutorInsideClassroomProps> = ({ classroomHub, localPeerRef, classroomName, setIsInsideClassroom }) => {
    ...
    return (
        <Grid>
            <Grid.Col span={8}>
                <WorkSpace classroomName={classroomName} localPeerRef={localPeerRef} isRemotePeerConnected={isStudentInsideClassroom} setIsWorkSpaceSavingChanges={setIsWorkSpaceSavingChanges} />
            </Grid.Col>
            <Grid.Col span={4}>
                <Stack>
