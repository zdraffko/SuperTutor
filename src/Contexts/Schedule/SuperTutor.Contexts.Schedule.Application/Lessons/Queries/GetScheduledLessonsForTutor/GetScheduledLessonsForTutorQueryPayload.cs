...
public class GetScheduledLessonsForTutorQueryPayload
{
    public GetScheduledLessonsForTutorQueryPayload(IEnumerable<ScheduledLesson> scheduledLessons) => ScheduledLessons = scheduledLessons;
